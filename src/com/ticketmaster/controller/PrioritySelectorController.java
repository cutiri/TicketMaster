...
class PrioritySelectorController implements ControllerT<Priority, Priority> {
    ...
    public Priority run(Priority priority) throws InvalidActionException {
        ...
        consoleView.addInputCollector(new ListInputCollector("Change Priority (Or leave blank to return to the ticket) ", "Invalid option, try again", "", Priority.getPriorityStringList()));
