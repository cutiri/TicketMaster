...
class StatusSelectorController implements ControllerT<Status, Status>{
    ...
    public Status run(Status status) throws InvalidActionException {
        statusSelectorView.addInputCollector(new InputCollectorList("Change Status to (Choose from below Or leave blank to return to the ticket): ", "Invalid option, please try again" , "", Status.getStatusStringList()));
